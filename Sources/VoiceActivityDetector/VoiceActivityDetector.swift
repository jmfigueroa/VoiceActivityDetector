...
public class VoiceActivityDetector {
    ...
    /// - Parameter aggressiveness: VAD operating "aggressiveness" mode.
    /// - Returns: `nil` in case of a memory allocation error.
    public convenience init?(sampleRate: Int = 8000, aggressiveness: DetectionAggressiveness = .quality) {
        self.init()
    ...
    /// - Parameter aggressiveness: VAD operating "aggressiveness" mode.
    /// - Returns: `nil` in case of a memory allocation error.
    public convenience init?(aggressiveness: DetectionAggressiveness = .quality) {
        self.init()
        self.aggressiveness = aggressiveness
    }
    ...
    /// VAD operating "aggressiveness" mode.
    public var aggressiveness: DetectionAggressiveness {
